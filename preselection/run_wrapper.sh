...
OUT_DIR="/data/userdata/$USER/vbs_vvh_rdf/test_mar03_01"
mkdir $OUT_DIR
...
python run_rdf.py etc/input_sample_jsons/sig_c2v1p0_c3_1p0/all_events/  -p $PREFIX -o $OUT_DIR -n sig_sm  -a all_events -m local -r 2
python run_rdf.py etc/input_sample_jsons/sig_c2v1p5_c3_1p0/all_events/  -p $PREFIX -o $OUT_DIR -n sig_c2v -a all_events -m local -r 2
python run_rdf.py etc/input_sample_jsons/sig_c2v1p0_c3_10p0/all_events/ -p $PREFIX -o $OUT_DIR -n sig_kl  -a all_events -m local -r 2
