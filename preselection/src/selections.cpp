...
RNode GenLevelSelections(RNode df_) {
    ...
    df = df.Define("excluded_jets_for_hbb", "ROOT::RVec<int>{truth_vbs1_idx, truth_vbs2_idx}")
            ...
            .Define("tempJet_hbb2_idx", find_matching_jet, {"b2_eta", "b2_phi", "excluded_jets_for_hbb2", "empty_fatjet_exclusions", "Jet_eta", "Jet_phi", "FatJet_eta", "FatJet_phi"})
    ...
    df = df.Define("excluded_jets_for_v2q1", "ROOT::RVec<int>{truth_vbs1_idx, truth_vbs2_idx, truth_h1_idx, truth_h2_idx, truth_v1_j1_idx, truth_v1_j2_idx}")
            ...
            .Define("tempJet_v2q1_idx", find_matching_jet, {"V2_q1_eta", "V2_q1_phi", "excluded_jets_for_v2q1", "excluded_fatjets_for_v2q1", "Jet_eta", "Jet_phi", "FatJet_eta", "FatJet_phi"})
            ...
            .Define("tempJet_v2q2_idx", find_matching_jet, {"V2_q2_eta", "V2_q2_phi", "excluded_jets_for_v2q2", "excluded_fatjets_for_v2q1", "Jet_eta", "Jet_phi", "FatJet_eta", "FatJet_phi"})
