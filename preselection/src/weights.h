...
############################################
*/
const std::unordered_map<std::string, correction::CorrectionSet> pileupIDScaleFactors = {
...
const std::unordered_map<std::string, std::string> pileupIDScaleFactors_yearmap = {
...
############################################
*/
const std::unordered_map<std::string, correction::CorrectionSet> PNETWScaleFactors = {
